            ...
            `cat > commands.json <<EOF
{
  "commands": [
    ...
    "export LOKI_URL=\\$(echo \\$SECRET | jq -r '.GRAFANA_LOKI_URL')",
    "export LOKI_INSTANCE_ID=\\$(echo \\$SECRET | jq -r '.GRAFANA_LOKI_INSTANCE_ID')",
    "export LOKI_API_KEY=\\$(echo \\$SECRET | jq -r '.GRAFANA_API_KEY')",
    "docker-compose down",
